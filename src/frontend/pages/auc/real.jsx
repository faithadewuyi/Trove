          ...
          <div className="w-5/6 p-4">
            <div className="flex justify-between items-center mb-6">
              <div className="flex space-x-4 ml-24">
                ...
                <button onClick={() => handleCategoryClick('edress')} className="text-blue-500 underline">
                  Evening Dress
                </button>
                <button onClick={() => handleCategoryClick('tuxedo')} className="text-blue-500 underline">
                  Tuxedo
                </button>
                <button onClick={() => handleCategoryClick('jumpsuit')} className="text-blue-500 underline">
                 Jumpsuit
                </button>
                <button onClick={() => handleCategoryClick('native')} className="text-blue-500 underline">
                 Native
                </button>
                <button onClick={() => handleCategoryClick('cdress')} className="text-blue-500 underline">
                  Cooperate Outfit
                </button>
                <button onClick={() => handleCategoryClick('suit')} className="text-blue-500 underline">
                  Suit
                </button>
                <button onClick={() => handleCategoryClick('wdress')} className="text-blue-500 underline">
                  Wedding
                </button>
            ...
            <div className="min-h-screen bg-gray-100 p-8 mb-20 mx-2">
